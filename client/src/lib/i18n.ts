...
const esTranslations = {
  ...
  pages: {
    cloudExplorer: {
      ...
      noResults: "Sin resultados", emptyFolder: "Carpeta vacía", folder: "carpeta", folders: "carpetas", file: "archivo", files: "archivos",
...
const enTranslations = {
  ...
  pages: {
    cloudExplorer: {
      ...
      noResults: "No results", emptyFolder: "Empty folder", folder: "folder", folders: "folders", file: "file", files: "files",
...
const ptTranslations = {
  ...
  pages: {
    cloudExplorer: {
      ...
      noResults: "Sem resultados", emptyFolder: "Pasta vazia", folder: "pasta", folders: "pastas", file: "arquivo", files: "arquivos",
      cancel: "Cancelar", transfer: "Transferir",
