...
const esTranslations = {
  ...
  pages: {
    ...
    tasks: {
      ...
      loading: "Cargando syncs...",
      automation: "Automatización",
      heroSubtitle: "Transferencias automáticas entre tus nubes",
      statActive: "Activas",
      statRuns: "Ejecuciones",
      statSuccess: "Tasa de éxito",
      statNext: "Próxima sync",
      statNow: "Ahora",
      noUpcoming: "—",
      planBannerTitle: "Función exclusiva Pro",
      planBannerDesc: "Automatizá hasta 5 syncs con el plan Pro",
      upgradeBtn: "Ver planes",
      countdownDays: "en {{n}}d",
      countdownHours: "en {{n}}h",
      countdownMins: "en {{n}}m",
      viewStats: "Ver estadísticas",
      hideStats: "Ocultar estadísticas",
      noRunsYet: "Sin ejecuciones registradas aún",
    },
    watchFolders: {
      title: "Watch Folders", hero: "Detectá y transferí archivos nuevos automáticamente",
      heroSubtitle: "Monitoreá una carpeta y transferí los archivos nuevos en cuanto aparezcan",
      add: "Agregar Watch Folder", createTitle: "Nueva Watch Folder", create: "Crear", creating: "Creando…",
      statActive: "Activas", statDetected: "Archivos detectados", statTransferred: "Transferidos",
      empty: "Sin watch folders", emptyDesc: "Agregá una para empezar a monitorear automáticamente",
      emptyDescFree: "Actualizá a Pro para desbloquear watch folders",
      planTitle: "Watch Folders requiere Pro o Business",
      planDesc: "Actualizá para monitorear carpetas y transferir archivos nuevos automáticamente.",
      limitReached: "Llegaste al límite de {{limit}} watch folder(s) de tu plan.",
      fieldName: "Nombre", namePlaceholder: "ej. Bandeja de facturas",
      fieldSourceProvider: "Proveedor origen", fieldSourceFolder: "ID carpeta origen",
      fieldSourceFolderName: "Nombre carpeta origen (opcional)",
      fieldDestProvider: "Proveedor destino", fieldDestFolder: "ID carpeta destino",
      fieldDestFolderName: "Nombre carpeta destino (opcional)",
      folderNamePlaceholder: "Nombre visible", destination: "Destino",
      fieldInterval: "Revisar cada", transferred: "transferidos",
      pause: "Pausar", resume: "Reanudar",
      deleteTitle: "¿Eliminar watch folder?",
      deleteDesc: "Se detendrá el monitoreo. Los archivos ya transferidos no se ven afectados.",
      errorCreate: "Error al crear watch folder",
    },
  },
  quickCopy: {
...
const enTranslations = {
  ...
  pages: {
    ...
    tasks: {
      ...
      loading: "Loading syncs...",
      automation: "Automation",
      heroSubtitle: "Automatic transfers between your clouds",
      statActive: "Active",
      statRuns: "Runs",
      ...
      statNow: "Now",
      noUpcoming: "—",
      planBannerTitle: "Pro feature only",
      planBannerDesc: "Automate up to 5 syncs with the Pro plan",
      upgradeBtn: "View plans",
      countdownDays: "in {{n}}d",
      countdownHours: "in {{n}}h",
      countdownMins: "in {{n}}m",
      viewStats: "View statistics",
      hideStats: "Hide statistics",
      noRunsYet: "No runs recorded yet",
    },
    watchFolders: {
      title: "Watch Folders", hero: "Auto-detect & transfer new files",
      heroSubtitle: "Monitor a folder and automatically transfer new files when they appear",
      add: "Add Watch Folder", createTitle: "New Watch Folder", create: "Create", creating: "Creating…",
      statActive: "Active", statDetected: "Files detected", statTransferred: "Transferred",
      empty: "No watch folders yet", emptyDesc: "Add one to start monitoring a folder automatically",
      emptyDescFree: "Upgrade to Pro to unlock watch folders",
      planTitle: "Watch Folders require Pro or Business",
      planDesc: "Upgrade to monitor folders and transfer new files automatically.",
      limitReached: "You've reached the limit of {{limit}} watch folder(s) on your plan.",
      fieldName: "Name", namePlaceholder: "e.g. Invoices Inbox",
      fieldSourceProvider: "Source provider", fieldSourceFolder: "Source folder ID",
      fieldSourceFolderName: "Source folder name (optional)",
      fieldDestProvider: "Dest. provider", fieldDestFolder: "Dest. folder ID",
      fieldDestFolderName: "Dest. folder name (optional)",
      folderNamePlaceholder: "Display name", destination: "Destination",
      fieldInterval: "Check every", transferred: "transferred",
      pause: "Pause", resume: "Resume",
      deleteTitle: "Delete watch folder?",
      deleteDesc: "This will stop monitoring. Already-transferred files are not affected.",
      errorCreate: "Error creating watch folder",
    },
  },
  quickCopy: {
  ...
  common: {
    ...
    navigation: {
      ...
      tasks: "Scheduled Syncs", watchFolders: "Watch Folders", health: "Cloud Health", cloudExplorer: "Multi-cloud Explorer",
...
const ptTranslations = {
  ...
  pages: {
    ...
    tasks: {
      ...
      loading: "Carregando syncs...",
      automation: "Automação",
      heroSubtitle: "Transferências automáticas entre suas nuvens",
      statActive: "Ativas",
      statRuns: "Execuções",
      statSuccess: "Taxa de sucesso",
      statNext: "Próxima sync",
      statNow: "Agora",
      noUpcoming: "—",
      planBannerTitle: "Função exclusiva Pro",
      planBannerDesc: "Automatize até 5 syncs com o plano Pro",
      upgradeBtn: "Ver planos",
      countdownDays: "em {{n}}d",
      countdownHours: "em {{n}}h",
      countdownMins: "em {{n}}m",
      viewStats: "Ver estatísticas",
      hideStats: "Ocultar estatísticas",
      noRunsYet: "Nenhuma execução registrada ainda",
    },
    watchFolders: {
      title: "Watch Folders", hero: "Detecte e transfira novos arquivos automaticamente",
      heroSubtitle: "Monitore uma pasta e transfira automaticamente novos arquivos quando aparecerem",
      add: "Adicionar Watch Folder", createTitle: "Nova Watch Folder", create: "Criar", creating: "Criando…",
      statActive: "Ativas", statDetected: "Arquivos detectados", statTransferred: "Transferidos",
      empty: "Nenhuma watch folder", emptyDesc: "Adicione uma para começar a monitorar automaticamente",
      emptyDescFree: "Atualize para Pro para desbloquear watch folders",
      planTitle: "Watch Folders requerem Pro ou Business",
      planDesc: "Atualize para monitorar pastas e transferir novos arquivos automaticamente.",
      limitReached: "Você atingiu o limite de {{limit}} watch folder(s) do seu plano.",
      fieldName: "Nome", namePlaceholder: "ex. Caixa de faturas",
      fieldSourceProvider: "Provedor origem", fieldSourceFolder: "ID pasta origem",
      fieldSourceFolderName: "Nome pasta origem (opcional)",
      fieldDestProvider: "Provedor destino", fieldDestFolder: "ID pasta destino",
      fieldDestFolderName: "Nome pasta destino (opcional)",
      folderNamePlaceholder: "Nome visível", destination: "Destino",
      fieldInterval: "Verificar a cada", transferred: "transferidos",
      pause: "Pausar", resume: "Retomar",
      deleteTitle: "Excluir watch folder?",
      deleteDesc: "O monitoramento será interrompido. Arquivos já transferidos não são afetados.",
      errorCreate: "Erro ao criar watch folder",
    },
  },
  quickCopy: {
  ...
  common: {
    ...
    navigation: {
      ...
      tasks: "Syncs Programadas", watchFolders: "Watch Folders", health: "Saúde da Nuvem", cloudExplorer: "Explorador Multi-nuvem",
