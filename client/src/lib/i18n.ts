...
const esTranslations = {
  ...
  settingsPage: {
    ...
    plan: { title: "Plan y Facturación", description: "Tu plan actual y opciones de actualización", active: "Activo", freeLabel: "Gratis", proPrice: "$7.99 USD/mes", businessPrice: "$19.99 USD/mes", trafficLabel: "Tráfico/mes", transfersLabel: "Transferencias", maxFileLabel: "Archivo máx.", upgradeTitle: "Mejorar plan", proSub: "200 GB · 300 transferencias", perMonth: "/mes", businessSub: "2 TB · Ilimitadas", upgradeToBusinessBtn: "Mejorar a Business", upgradeToBusinessSub: "2 TB · archivos de 50 GB · soporte 4h", viewPlans: "Ver comparación completa de planes", cancelLink: "Cancelar suscripción", cancelTitle: "¿Cancelar suscripción?", cancelDesc: "Tu plan seguirá activo hasta el fin del período actual. Después pasarás al plan Free.", cancelConfirmBtn: "Confirmar cancelación", keepPlanBtn: "Mantener plan" },
    preferences: { title: "Preferencias", description: "Idioma y configuraciones de la interfaz", languageLabel: "Idioma de la interfaz", languageSub: "Cambia el idioma de toda la aplicación" },
    account: { title: "Información de Cuenta", userId: "ID de Usuario", memberSince: "Miembro desde", servicesTitle: "Servicios Conectados", connected: "Conectado", notConnected: "No conectado" },
...
const enTranslations = {
  ...
  settingsPage: {
    ...
    plan: { title: "Plan & Billing", description: "Your current plan and upgrade options", active: "Active", freeLabel: "Free", proPrice: "$7.99 USD/mo", businessPrice: "$19.99 USD/mo", trafficLabel: "Traffic/month", transfersLabel: "Transfers", maxFileLabel: "Max. file", upgradeTitle: "Upgrade plan", proSub: "200 GB · 300 transfers", perMonth: "/mo", businessSub: "2 TB · Unlimited", upgradeToBusinessBtn: "Upgrade to Business", upgradeToBusinessSub: "2 TB · 50 GB files · 4h support", viewPlans: "View full plan comparison", cancelLink: "Cancel subscription", cancelTitle: "Cancel subscription?", cancelDesc: "Your plan will remain active until the end of the current period. Then you'll be downgraded to Free.", cancelConfirmBtn: "Confirm cancellation", keepPlanBtn: "Keep plan" },
    preferences: { title: "Preferences", description: "Language and interface settings", languageLabel: "Interface language", languageSub: "Change the language of the entire app" },
    account: { title: "Account Information", userId: "User ID", memberSince: "Member since", servicesTitle: "Connected Services", connected: "Connected", notConnected: "Not connected" },
