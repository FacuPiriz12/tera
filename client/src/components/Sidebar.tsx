...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      className={`bg-white border-r border-slate-200 hidden sm:flex flex-col fixed left-0 top-[75px] h-[calc(100vh-75px)] transition-all duration-300 ease-in-out z-[90] ${
