...
import {
  ...
  Twitter, Linkedin, Github, ArrowLeftRight, FolderSync, Bell, MessageSquare,
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-16">
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4 mt-8">
                <a href="https://discord.gg/5bH4CQ5bX2" target="_blank" rel="noopener noreferrer" title="Discord Community" className="w-9 h-9 bg-gray-50 rounded-xl flex items-center justify-center text-gray-400 hover:bg-indigo-500 hover:text-white transition-all">
